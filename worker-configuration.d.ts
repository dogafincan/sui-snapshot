/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8ad868afe0d508fb2b32747abcaf8cdf)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BLOCKBERRY_API_KEY">> {}
}
